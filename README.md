...
This will create a new conda environment named `makeuoft` (you may choose a different name) with all the dependencies pre-installed. Then, activate the environment:
...
For mandatory environment variables, run
...
The main project configs are in [hackathon_site/hackathon_site](hackathon_site/hackathon_site), including the main settings file [settings/\_\_init\_\_.py](hackathon_site/hackathon_site/settings/__init__.py) and top-level URL config.
